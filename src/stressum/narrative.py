...
def write_narrative(
    ...
    lines = [
        ...
        "",
        f"- **Sum of successful throughput:** {agg.total_successful_rps:.6g} RPS",
        f"- **Sum of error throughput:** {agg.total_error_rps:.6g} RPS",
        f"- **Sum of completed throughput:** {agg.total_completed_rps:.6g} RPS",
