...
- `ojp_heap_used_vs_load.png`: `ojp_heap_used_mib` from `summary_stats.csv` when OJP JVM heap data exists.
- `ojp_heap_committed_vs_load.png`: `ojp_heap_committed_mib` from `summary_stats.csv` when OJP JVM heap data exists.
- `ojp_heap_used_committed_max_vs_load.png`: `ojp_heap_used_mib`, `ojp_heap_committed_mib`, and `ojp_heap_max_mib` from `summary_stats.csv` when OJP JVM heap data exists.
